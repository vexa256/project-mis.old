        ...
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form action="{{ route('MassInsert') }}" class="row" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <select required name="ExpenditureGroup" class="form-select   form-select-solid" data-control="select2" data-placeholder="Select a option">
                                ...
                                <option value="{{ $up->ExpenditureGroup }}">
                                    {{ $up->ExpenditureGroup }}
                    ...
                    <input required type="hidden" name="EID" value="{{ md5(\Hash::make(uniqid() . 'AFC' . date('Y-m-d H:I:S'))) }}">


                    <input required type="hidden" name="TableName" value="project_activity_expenditures">
